...
case "${machine}" in
    Mac) ($AIWHISPR_HOME/shell/start-search-service.sh -H 127.0.0.1 -P 5002 -C $AIWHISPR_HOME/config/content-site/sites-available/example_askubuntu.xml.qdrant.cfg &> /tmp/search.example_askubuntu.xml.qdrant.log & );;
    *) ($AIWHISPR_HOME/shell/start-search-service.sh -H 127.0.0.1 -P 5002 -C $AIWHISPR_HOME/config/content-site/sites-available/example_askubuntu.xml.qdrant.cfg &> /tmp/search.example_askubuntu.xml.qdrant.log &);;
esac
