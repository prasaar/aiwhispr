...
configFile="${AIWHISPR_HOME}"/config/content-site/sites-available/example_askubuntu.xml.typesense.cfg
...
tmpConfigFile="/tmp/example_askubuntu.xml.typesense.cfg.tmp"
...
echo "sitename=example_askubuntu.xml.typesense" >> $tmpConfigFile
