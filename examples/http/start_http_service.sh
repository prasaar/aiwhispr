...
case "${machine}" in
    Mac) (nohup $AIWHISPR_HOME/shell/start-search-service.sh -H 127.0.0.1 -P 5002 -C $AIWHISPR_HOME/config/content-site/sites-available/example_bbc.filepath.macos.cfg &> /tmp/example_bbc.searchservice.log &);;
    *) (nohup $AIWHISPR_HOME/shell/start-search-service.sh -H 127.0.0.1 -P 5002 -C $AIWHISPR_HOME/config/content-site/sites-available/example_bbc.filepath.cfg &> /tmp/example_bbc.searchservice.log &);;
esac
