...
case "${machine}" in
    Mac) ($AIWHISPR_HOME/shell/start-search-service.sh -H 127.0.0.1 -P 5002 -C $AIWHISPR_HOME/config/content-site/sites-available/example_bbc.filepath.milvus.cfg &> /tmp/search.example_bbc.filepath.milvus.log & );;
    *) ($AIWHISPR_HOME/shell/start-search-service.sh -H 127.0.0.1 -P 5002 -C $AIWHISPR_HOME/config/content-site/sites-available/example_bbc.filepath.milvus.cfg &> /tmp/search.example_bbc.filepath.milvus.log &);;
esac
