...
class aiwhisprMSpptxDocProcessor(srcDocProcessor):
    ...
    def extractText(self):
        #This is a MS Office 2007 onwards .pptx document text extractor

        self.logger.debug('This is a .pptx file form which we will extract text')
